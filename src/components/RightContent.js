const RightContent = () => {
  return (
    <div className="right-content">
      ...
      <p>
        Apply critical thinking and quantitative reasoning to approach complex
        problems and demonstrate skills in data analysis and modeling.
      </p>
      ...
      <p>
        Honors contracts and commitments, and adheres to professional standards,
        respectful of people, time, resources, responsibilities with excellence
        and decision making.
      </p>
    </div>
  );
